...
/**
 * __usePastLaunchesQuery__
 *
 * To run a query within a React component, call `usePastLaunchesQuery` and pass it any options that fit your needs.
 * When your component renders, `usePastLaunchesQuery` returns an object from Apollo Client that contains loading, error, and data properties
...
export function usePastLaunchesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<PastLaunchesQuery, PastLaunchesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<PastLaunchesQuery, PastLaunchesQueryVariables>(
    PastLaunchesDocument,
    options
  );
}
export type PastLaunchesQueryHookResult = ReturnType<typeof usePastLaunchesQuery>;
export type PastLaunchesLazyQueryHookResult = ReturnType<typeof usePastLaunchesLazyQuery>;
